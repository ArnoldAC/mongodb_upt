    ...
    public partial class FrmDetalleInmueble : Form
    {
        ...
        private void btnagregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var database = client.GetDatabase("db_SNR");
                var collection = database.GetCollection<BsonDocument>("Publico");

                //collection.Indexes.CreateOne(new BsonDocument("idinmueble", 1));

                //datos del documento ingresado
                var document = new BsonDocument
                {
                    ...
                    //{ "estado", "activo"},
                    { "categoria",CboEstado.Text },
                    { "precio", txtprecio.Text},
                    { "descripcion", txtdescripcion.Text},                    
                };
                //insertar en la collecion
